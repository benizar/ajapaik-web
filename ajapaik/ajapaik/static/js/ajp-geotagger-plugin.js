(function () {
    ...
    var AjapaikGeotagger = function (node, options) {
        ...
        this.UI = $([
            ...
            "    <div class='col-12 col-md-9 ajp-full-height p-0' id='ajp-geotagger-map-container'>",
            "        <div id='ajp-geotagger-map-canvas'></div>",
            "    </div>",
            "    <div class='col-12 col-md-3 p-0 ajp-cols-bottom' id='ajp-geotagger-panel'>",
    ...
    AjapaikGeotagger.prototype = {
        ...
        initializeMap: function () {
            ...
            this.vgmapi = new VanalinnadGooglemApi(null, true, map);
